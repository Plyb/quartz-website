...
2. Median or Percentile: the point at which it becomes more likely than not[^5] that AGI will have arrived. My guess is this is what most people mean, since this seems to be very common in cases where the definition of the metric is explicitly given: see Metaculus, Manifold, Epoch AI, and ESPAI.
